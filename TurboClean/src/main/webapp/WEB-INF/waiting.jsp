...
<body style="background-color: #cad1d1;">
	...
	<main
		...
		<h1 class="text-center fw-bold mb-5 text-white"
			style="font-size: 36px;">📦 Orders Waiting</h1>
