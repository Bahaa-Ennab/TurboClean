...
<body>
	...
	<article>
		...
		<div class="details-container">
			...
			<p>
				<strong>Username:</strong> <span id="v_username"><c:out
						value="${user.username}" /></span>
			</p>
			<p>
				<strong>Email:</strong> <span id="v_email"><c:out
						value="${user.email}" /></span>
			</p>
			<p>
				<strong>Phone:</strong> <span id="v_phone"><c:out
						value="${user.phoneNumber}" /></span>
			</p>
			<p>
				<strong>Location:</strong> <span id="v_location"><c:out
						value="${user.location}" /></span>
			</p>
			<p>
				<strong>Role:</strong> <span id="v_role"><c:out
			...
			<div class="modal-content">
				...
				<form id="editForm">
					<label for="username">Username:</label> <input type="text"
						id="username" name="username" value="${user.username}" /> <label
						for="email">Email:</label> <input type="email" id="email"
						name="email" value="${user.email}" /> <label for="phoneNumber">Phone
						Number:</label> <input type="text" id="phoneNumber" name="phoneNumber"
						value="${user.phoneNumber}" /> <label for="password">Password:</label>
					<input type="password" id="password" name="password"
						value="${user.password}" /> <label for="location">Location:</label>
					<input type="text" id="location" name="location"
						value="${user.location}" /> <label for="role">Role:</label> <input
						type="text" id="role" name="role" value="${user.role}" /> <input
						type="submit" value="Save" style="margin-top: 15px;" />
